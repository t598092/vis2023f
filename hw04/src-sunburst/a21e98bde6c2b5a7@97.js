...
FileAttachment("artist@2.csv").csv()
)}
...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>多半人為減少碳排放採取的行動相似</li>
    <li>美術館的藝術工作者較其他工作者相比，更常使用減少商務差旅的方式減少碳排放量</li>
    <li>非營利組織/藝術團體的工作者採取的行動分布較為平均</li>
  </ul>
</h3>`
)}
...
d3
  ...
  .range(["#939650","#6C6024","#4D5139","#7BA23F","#66327C","#904840"])
  .unknown("#bbbb")
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artist@2.csv", {url: new URL("./artist.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
